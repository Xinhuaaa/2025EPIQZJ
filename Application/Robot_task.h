...
// 放置点位置宏定义 A-F
// 路线1 bcdefa
#define MoveToA1() Chassis_MoveToPosition_Blocking(-0.685f, -0.205f, -90.0f, 10000)
#define MoveToB1() Chassis_MoveToPosition_Blocking(-0.700f, -0.650f,   0.0f, 10000)
#define MoveToC1() Chassis_MoveToPosition_Blocking(-0.700f, -0.198f,   0.0f, 10000)
#define MoveToD1() Chassis_MoveToPosition_Blocking(-0.700f,  0.249f,   0.0f, 10000)
#define MoveToE1() Chassis_MoveToPosition_Blocking(-0.700f,  0.710f,   0.0f, 10000)
#define MoveToF1() Chassis_MoveToPosition_Blocking(-0.685f,  0.295f, -90.0f, 10000)
...
// 路线0 edcba
#define MoveToA0() Chassis_MoveToPosition_Blocking(-0.665f, -0.195f, -90.0f, 10000)
#define MoveToB0() Chassis_MoveToPosition_Blocking(-0.700f, -0.650f,   0.0f, 10000)
#define MoveToC0() Chassis_MoveToPosition_Blocking(-0.700f, -0.198f,   0.0f, 10000)
#define MoveToD0() Chassis_MoveToPosition_Blocking(-0.700f,  0.249f,   0.0f, 10000)
#define MoveToE0() Chassis_MoveToPosition_Blocking(-0.700f,  0.710f,   0.0f, 10000)
#define MoveToF0() Chassis_MoveToPosition_Blocking(-0.685f,  0.295f, -90.0f, 10000)
