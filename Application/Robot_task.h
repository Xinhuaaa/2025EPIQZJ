...
#include "chassis.h"
// 抓取位置宏定义
#define MoveToLeft() Chassis_MoveToPosition_Blocking(1.60, 0.493, 0, 2000)
#define MoveToCenter() Chassis_MoveToPosition_Blocking(1.60, 0, 0, 2000)
#define MoveToRight() Chassis_MoveToPosition_Blocking(1.60, -0.507, 0, 2000)
/* 位置移动宏定义 */
// 放置点位置宏定义 A-F
// 路线1 bcdefa
#define MoveToA1() Chassis_MoveToPosition_Blocking(-0.685, -0.172, -90, 0)
...
#define MoveToF1() Chassis_MoveToPosition_Blocking(-0.685,0.292, -90, 0)
// 路线0 edcba
