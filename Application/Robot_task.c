    ...
    uint8_t placementSpecialBox =specialBox;
        ...
        case 1:
            for(int i = 0; i < 6; i++) {                
                ...
                int is_reverse_place = (i == 5 && spareStack == 1 && i != placementSpecialBox) ? 1 : 0;
                Crawl_PlaceBox(i, placementSpecialBox, is_reverse_place);
                if(i == placementSpecialBox) {
                Lift_To_PUTspecialUUP();
                }
                if (i==3 && i != placementSpecialBox)  // 如果是放置E位置，移动到放置点
                {
                    Lift_To_PUTspecialUUP();
                    Chassis_MoveToPosition_Blocking(-0.74, 0.0, 0, 0);
                }
        ...
        case 0:
            for(int i = 0; i < 6; i++) {
                ...
                int is_reverse_place = (i == 5 && spareStack == 2 || i == 4 && spareStack == 2) ? 1 : 0;
                Crawl_PlaceBox(i, placementSpecialBox, is_reverse_place);
                if(i == placementSpecialBox) {
                Lift_To_PUTspecialUUP();
                }
